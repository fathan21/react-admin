...
class IzinKerja extends Component {
  ...
  constructor (props) {
    ...
    this.state = {
                  ...
                  tHead:[{key:'no',label:"No",sort:false},
                          {key:'nama_pekerjaan',label:"Nama Pekerjaan",sort:false},
                          {key:'lokasi_pekerjaan',label:"Lokasi Pekerjaan",sort:true},
                          {key:'tgl_pelaksanaan',label:"Tgl Pelaksanaan",sort:true},
                          {key:'tgl_selesai',label:"Tgl Selesai",sort:true},
                          {key:'supervisi',label:"Supervisi",sort:true},
                          {key:'total_manpower',label:"Total Manpower",sort:true},
    ...
    return cols.map(function(item,key) {
        return (
            <tr  key={item.id}>
              ...
              <td>{dateFormat(item.tgl_pelaksanaan)}</td>
