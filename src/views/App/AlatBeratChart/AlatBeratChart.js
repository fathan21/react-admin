...
class AlatBeratChart extends Component {
  constructor(props) {
    super(props);
                  ...
                  <Col sm="12">
                      <Form id="myFrom"  onSubmit={this.onSubmit} inline>
                        <FormGroup className="pr-1">
                          <Label htmlFor="exampleInputName2" className="pr-1">Tgl Masuk Dari</Label>
                          <DatePicker
                        ...
                        <FormGroup className="pr-1">
                          <Label htmlFor="exampleInputEmail2" className="pr-1">Tgl Masuk Sampai</Label>
                            <DatePicker
