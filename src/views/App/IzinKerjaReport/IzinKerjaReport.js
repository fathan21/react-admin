...
class IzinKerjaReport extends Component {
  constructor(props) {
    super(props);
          ...
          <Card className="border-primary">
            ...
            <CardBody>
                  ...
                  <Col sm="12">
                      <Form id="myFrom"  onSubmit={this.onSubmit} >
                        <FormGroup className="pr-1" row>
                          <Label htmlFor="exampleInputName2" sm="2" className="pr-1">Tgl Pel. Dari</Label>
                          <DatePicker
                          ...
                          <Label sm="2" size="sm" htmlFor="input-small">Lokasi</Label>
                          <Col sm="4">
                            <select name="lokasi" id="lokasi" className="form-control input-sm">
                              <option value=""></option>
                              {this.state.options.lokasi.map(function (item, key) {
                                return (
                                  <option key={key} value={item.lokasi}>{item.lokasi}</option>
                                )
                        ...
                        <FormGroup className="pr-1" row>
                          <Label htmlFor="exampleInputEmail2" sm="2" className="pr-1">Tgl Pel. Sampai</Label>
                            <DatePicker
                          ...
                          <Label htmlFor="exampleInputEmail2" sm="2" className="pr-1">Supervisi</Label>
                          <Col sm="4">
                            <select name="supervisi" id="supervisi" className="form-control input-sm">
                              <option value=""></option>
                              {this.state.options.supervisi.map(function (item, key) {
                                return (
                                  <option key={key} value={item.supervisi}>{item.supervisi}</option>
                                )
              ...
              <div className="chart-wrapper" id="print_area">
                <table  width="100%">
                  <tr><td align="center"><h3>Laporan Izin Kerja</h3></td></tr>
                ...
                <table  className="table-report" border="1" width="100%" align="center">
                    ...
                    <tr  style={{backgroundColor:'#cccccc'}}>
                      ...
                      <td  align="center">Lokasi Pekerjaan</td>
                      <td  align="center">Tgl Pelaksanaan</td>
                      <td  align="center">Tgl Selesai</td>
                      <td  align="center">Supervisi</td>
                      <td  align="center">Total Manpower</td>
                    </tr>
                    {this.state.data.map(function(item, key) {
                       return (
                          <tr key = {key}>
                              <td  align="center">{item.nama_pekerjaan}</td>
                              <td  align="center">{item.lokasi_pekerjaan}</td>
                              <td align="center">{dateFormat(item.tgl_pelaksanaan)}</td>
                              <td align="center">{dateFormat(item.tgl_selesai)}</td>
                              <td  align="center">{item.supervisi}</td>
                              <td  align="center">{item.total_manpower}</td>
                          </tr>
                        )
                     })}
                </table>
...
export default IzinKerjaReport;
