...
class AlatBerat extends Component {
  ...
  constructor (props) {
    ...
    this.state = {
                  ...
                  tHead:[{key:'no',label:"No",sort:false},
                          {key:'nama_alat',label:"Nama Alat",sort:false},
                          {key:'model',label:"Model",sort:true},
                          {key:'nomer_seri',label:"No. Seri",sort:true},
                          {key:'tgl_masuk',label:"Tgl Masuk",sort:true},
                          {key:'nama_perushaan',label:"Nama Perusahaan",sort:true},
                          {key:'operator',label:"Operator",sort:true},
