...
class KecelakaanKerjaForm extends Component {
  constructor(props) {
    super(props);
    this.state = {id:0,title:'kecelakaan_kerja',action:'add',disabled:false,apiUrl:'kecelakaan_kerja',alert:{msg:'test',type:'info',open:false},imagePreviewUrl:'',imageFile:'',
                    tgl:null,
  ...
  get(id){
    ...
    .then((res) => {
      ...
      //datepciker
      if(res.data.tgl!=undefined && res.data.tgl!='' && res.data.tgl!=null ){
        let j = moment(res.data.tgl);
        this.setState({tgl:j});
      }
    })
          ...
          <Card>
              ...
              <CardBody>
                ...
                <Form id="myFrom" className="form-horizontal" onSubmit={this.onSubmit}>
                      ...
                      <FormGroup row>
                        <Col md="3">
                          <Label htmlFor="tgl_pelaksanaan">Tgl</Label>
                        </Col>
                        <Col xs="12" md="9">
                          <DatePicker
                              ...
                              onSelect={(e)=>this._handleDpSelect(e,'tgl')}
                              onChange={(e)=>this._handleDpChange(e,'tgl')}
                              className="form-control"
                              placeholderText={this.state.dateFormat}
                              dateFormat={this.state.date_format_display}
                          />
                          <Input type="hidden" name="tgl" id="tgl"  disabled={this.state.disabled}/>
                        </Col>
                      </FormGroup>
                  <Row>
                    <Col md="6">
                      <FormGroup row>
                        <Col md="6">
                          <Label htmlFor="no_first_aid">No First Aid </Label>
                        </Col>
                        <Col xs="12" md="6">
                          <Input type="number" name="no_first_aid" id="no_first_aid"   required  disabled={this.state.disabled}/>
                        </Col>
                      </FormGroup>
                      <FormGroup row>
                        <Col md="6">
                          <Label htmlFor="no_fatality">No Fatality</Label>
                        </Col>
                        <Col xs="12" md="6">
                          <Input type="number" name="no_fatality" id="no_fatality"   required  disabled={this.state.disabled}/>
                        </Col>
                      </FormGroup>
                      <FormGroup row>
                        <Col md="6">
                          <Label htmlFor="no_medical_case">No Medical Case</Label>
                        </Col>
                        <Col xs="12" md="6">
                          <Input type="number" name="no_medical_case" id="no_medical_case"   required  disabled={this.state.disabled}/>
                        </Col>
                      </FormGroup>
                      <FormGroup row>
                        <Col md="6">
                          <Label htmlFor="no_nears_miss">"No Nears Miss</Label>
                        </Col>
                        <Col xs="12" md="6">
                          <Input type="number" name="no_nears_miss" id="no_nears_miss"   required  disabled={this.state.disabled}/>
                        </Col>
                      </FormGroup>
                      <FormGroup row>
                        <Col md="6">
                          <Label htmlFor="no_fire">No Fire</Label>
                        </Col>
                        <Col xs="12" md="6">
                          <Input type="number" name="no_fire" id="no_fire"   required  disabled={this.state.disabled}/>
                        </Col>
                      </FormGroup>
                    ...
                    <Col md="6">
                      <FormGroup row>
                        <Col md="6">
                          <Label htmlFor="equipment_incident">Equipment Incident</Label>
                        </Col>
                        <Col xs="12" md="6">
                          <Input type="number" name="equipment_incident" id="equipment_incident"   required  disabled={this.state.disabled}/>
                        </Col>
                      </FormGroup>
                      <FormGroup row>
                        <Col md="6">
                          <Label htmlFor="auto_mobile_ancident">Auto_mobile Ancident</Label>
                        </Col>
                        <Col xs="12" md="6">
                          <Input type="number" name="auto_mobile_ancident" id="auto_mobile_ancident"   required  disabled={this.state.disabled}/>
                        </Col>
                      </FormGroup>
                      <FormGroup row>
                        <Col md="6">
                          <Label htmlFor="environmental_accident">Environmental Accident</Label>
                        </Col>
                        <Col xs="12" md="6">
                          <Input type="number" name="environmental_accident" id="environmental_accident"   required  disabled={this.state.disabled}/>
                        </Col>
                      </FormGroup>
                      <FormGroup row>
                        <Col md="6">
                        ...
                        <Col xs="12" md="6">
                          <Input type="number" name="unsafe_condition" id="unsafe_condition"   required  disabled={this.state.disabled}/>
                        </Col>
                      </FormGroup>
                      <FormGroup row>
                        <Col md="6">
                        ...
                        <Col xs="12" md="6">
                          <Input type="number" name="unsafe_action" id="unsafe_action"   required  disabled={this.state.disabled}/>
                        </Col>
                      </FormGroup>
...
export default KecelakaanKerjaForm;
