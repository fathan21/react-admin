          ...
          <Card className="border-primary">
            ...
            <CardBody>
                  ...
                  <Col sm="12">
                      <Form id="myFrom"  onSubmit={this.onSubmit} >
                        <FormGroup className="pr-1" row>
                          ...
                          <Label sm="2" size="sm" htmlFor="input-small">Jenis Kelamin</Label>
                          <Col sm="4">
                            <select name="jenis_kelamin" id="jenis_kelamin" className="form-control input-sm">
                              <option value=""></option>
                              <option value="L">Laki2</option>
                        ...
                        <FormGroup className="pr-1" row>
                          ...
                          <Label htmlFor="exampleInputEmail2" sm="2" className="pr-1">Jabatan</Label>
                          <Col sm="4">
                            <select name="jabatan" id="jabatan" className="form-control input-sm">
                              <option value=""></option>
                              {this.state.options.jabatan.map(function (item, key) {
                                return (
                                  <option key={key} value={item.jabatan}>{item.jabatan}</option>
                                )
              ...
              <div className="chart-wrapper" id="print_area">
                <table  width="100%">
                  <tr><td align="center"><h3>Laporan Karyawan</h3></td></tr>
                ...
                <table  className="table-report" border="1" width="100%" align="center">
                    ...
                    {this.state.data.map(function(item, key) {
                       return (
                          <tr key = {key}>
                              <td  align="center">
                                <img  style={{ width:'50px',height:'50px',display: item.imagePreviewUrl=='' ? 'none' : '' }} src={item.imagePreviewUrl}  />
                              </td>
